...
question_count = 1
for i in range(1, 31):
    with open(f'Templates/AZ-900 Exam – Free Actual Q&As, Page {i} _ ExamTopics.html', encoding='utf8') as f:
        content = f.read()
        ...
        for ele in soup.find_all('div', {'class': 'questions-container'}):
            ...
            for img in ele.find_all('img', {'class': 'in-exam-image'}):
                img['src'] = "https://examtopics.com"+img['src']
